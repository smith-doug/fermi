...
class PointTreeItem : public QObject
{
	Q_OBJECT
	...
	Q_SIGNALS:
		void itemValueChanged(PointTreeItem& item, const int column, const QVariant& value);

	protected:
		void emitItemValueChangedSignal(PointTreeItem& item, const int column, const QVariant& value);
