 ...
 *             The concept of this class is to initialize all the necessary parameters for setting Cartesian Impedance
 *             parameters set from the UI..
 *             It gets the necessary parameters for Cartesian Impedance and sends them via particular topic to the robot
 *             driver.
 *  @author    Risto Kojcev
 */
